...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-primary/10 via-foreground/5 to-secondary/10 border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-12">
          {/* Logo & Description */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img src={gtfLogo} alt="GraminTech Foundation" className="h-16 w-auto" />
              <div>
                <p className="font-bold text-xl text-foreground">GraminTech</p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-lg text-foreground mb-4">{t('quickLinks')}</h3>
          ...
          {/* Social Media */}
          <div>
            <h3 className="font-bold text-lg text-foreground mb-4">{t('followUs')}</h3>
